...
## Rodando o Front-end
Navegar para a pasta "web" e utilize o comando: yarn
Após instalados os modulos basta rodar o comando: yarn start
Pronto! Front-end rodando

## Rodando o Back-end:
Navegue até a pasta "server" e utilize o comando: yarn

Após instalados os modulos basta rodar o comando:yarn dev:server
...
Para inicializar a base de dados utilizo o comando: docker start "id-do-meu-docker"

Para as migrations uso o script: yarn typeorm migration:run
